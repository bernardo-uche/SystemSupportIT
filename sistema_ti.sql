...
CREATE DATABASE sistema_ti CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE sistema_ti;

/* ============================================================
   MÓDULO 1: PERSONAL, EQUIPOS, CLIENTES, ÓRDENES Y DIAGNÓSTICOS
   ============================================================ */
...
/* ============================================================
   MÓDULO 3: USUARIOS, ROLES, CATEGORÍAS, REPUESTOS Y VENTAS
   ============================================================ */
...
/* ============================================================
   MÓDULO 2: PROVEEDORES, COMPRAS, OFERTAS Y COTIZACIONES
   ============================================================ */
...
CREATE TABLE cotizaciones (
    ...
    FOREIGN KEY (id_oferta) REFERENCES ofertas(id_oferta) ON UPDATE CASCADE ON DELETE SET NULL
);
...
/* ============================================================
   MÓDULO 5: HERRAMIENTAS Y MANTENIMIENTO
   ============================================================ */
...
CREATE TABLE herramientas (
    ...
    CONSTRAINT herramientas_categoria_foreign FOREIGN KEY (id_categoria_herramienta) REFERENCES categorias_herramientas(id_categoria_herramienta) ON DELETE RESTRICT
);
...
CREATE TABLE trabajos_mantenimiento (
    ...
    CONSTRAINT trabajos_diagnostico_foreign FOREIGN KEY (id_diagnostico) REFERENCES diagnosticos(id_diagnostico) ON DELETE CASCADE,
    CONSTRAINT trabajos_mantenimiento_foreign FOREIGN KEY (id_mantenimiento) REFERENCES mantenimientos(id_mantenimiento) ON DELETE RESTRICT
);
...
CREATE TABLE asignaciones (
    ...
    CONSTRAINT asignaciones_trabajo_foreign FOREIGN KEY (id_trabajo_mantenimiento) REFERENCES trabajos_mantenimiento(id_trabajo_mantenimiento) ON DELETE CASCADE,
    CONSTRAINT asignaciones_personal_foreign FOREIGN KEY (id_personal) REFERENCES personal(id_personal) ON DELETE RESTRICT
);
...
CREATE TABLE trabajo_herramientas (
    ...
    CONSTRAINT trabajo_herramientas_trabajo_foreign FOREIGN KEY (id_trabajo_mantenimiento) REFERENCES trabajos_mantenimiento(id_trabajo_mantenimiento) ON DELETE CASCADE,
    CONSTRAINT trabajo_herramientas_herramienta_foreign FOREIGN KEY (id_herramienta) REFERENCES herramientas(id_herramienta) ON DELETE RESTRICT
);
...
CREATE TABLE trabajo_repuestos (
    ...
    CONSTRAINT trabajo_repuestos_trabajo_foreign FOREIGN KEY (id_trabajo_mantenimiento) REFERENCES trabajos_mantenimiento(id_trabajo_mantenimiento) ON DELETE CASCADE,
    CONSTRAINT trabajo_repuestos_repuesto_foreign FOREIGN KEY (id_repuesto) REFERENCES repuestos(id_repuesto) ON DELETE RESTRICT
);

/* ============================================================
   MÓDULO 4: INVENTARIO, LOTE_STOCK, KARDEX E INVENTARIO FÍSICO
   ============================================================ */
...
CREATE TABLE inventario (
    ...
    observacion VARCHAR(255) DEFAULT NULL,
    id_usuario_creacion BIGINT UNSIGNED NOT NULL,
    estado TINYINT(1) NOT NULL DEFAULT 1,
    created_at TIMESTAMP NULL DEFAULT NULL,
    updated_at TIMESTAMP NULL DEFAULT NULL,
...
CREATE TABLE kardex (
    ...
    id_lote_stock BIGINT UNSIGNED NOT NULL,
...
CREATE TABLE inventario_fisico (
    ...
    stock_sistema BIGINT UNSIGNED NOT NULL,
    stock_contado BIGINT UNSIGNED NOT NULL,
...
('Admin', 'Frontend', 'Administrador', '77700000', 'admin@gmail.com', 1, NOW());
...
-- 7. ROLES Y USUARIOS
INSERT INTO roles (nombre, descripcion, estado, created_at) VALUES
('administrador', 'Administrador General', 1, NOW()),
('tecnico', 'Técnico de Servicio', 1, NOW()),
('vendedor', 'Vendedor de Repuestos', 1, NOW()),
('supervisor', 'Supervisor de Área', 1, NOW());
...
(7, 'Ana', 'Fernández', 'admin@gmail.com', 'admin123', 1, NOW());
...
(5, 3, 1),  -- Luis - Vendedor
(6, 2, 1),  -- Ana - Técnico
(7, 1, 1);  -- Admin Frontend - Admin

-- 8. CATEGORÍAS Y REPUESTOS
...
-- 22. KARDEX
INSERT INTO kardex (
    id_inventario, id_lote_stock, id_detalle_compra, id_detalle_venta, 
    id_trabajo_repuesto, id_usuario, tipo_movimiento, cantidad_entrada, 
    cantidad_salida, saldo_anterior, saldo_actual, concepto, referencia, 
...
-- 23. INVENTARIO FÍSICO
INSERT INTO inventario_fisico (
    id_inventario, id_usuario, fecha_conteo, stock_sistema, 
    stock_contado, diferencia, resultado, observacion, created_at
) VALUES
